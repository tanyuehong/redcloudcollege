...
import com.redskt.collegeservice.service.EduAdminService;
...
@Service
public class EduAdminServiceImpl implements EduAdminService {
    ...
    public Map<String, Object> getUserInfo(String username) {
        ...
        EduAdminUser user = userService.selectByUsername(username);
        if (null == user) {
            //throw new GuliException(ResultCodeEnum.FETCH_USERINFO_ERROR);
        }

        //根据用户id获取角色
        List<EduRole> roleList = roleService.selectRoleByUserId(user.getId());
