...
public class EduPermissionController {
    ...
    public R indexAllPermission() {
        List<EduPermission> list =  permissionService.queryAllMenu();
    ...
    public R toAssign(@PathVariable String roleId) {
        List<EduPermission> list = permissionService.selectAllMenu(roleId);
        return R.ok().data("children", list);
    }
    ...
    @PostMapping("save")
    public R save(@RequestBody EduPermission permission) {
    ...
    @PutMapping("update")
    public R updateById(@RequestBody EduPermission permission) {
